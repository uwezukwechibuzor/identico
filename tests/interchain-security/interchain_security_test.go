...
import (
	...
	appConsumer "github.com/uwezukwechibuzor/Identico/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and old consumer chain
